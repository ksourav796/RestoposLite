app.controller('discountreport', function ($scope, $http, $rootScope, Notification) {
    ...
    $http.get("/reports/invoice/onLoadPageData").then(function (data) {
        ...
        $scope.paymentVoucherList = data.data.paymentVoucherList;
    ...
    $scope.getPaginatedSalesInvoice = function (page) {
        ...
        if (!$scope.isFilterApplied) {
            ...
            $http.get("/reports/restaurantInvoicePaymentList?type="+"discount", {
                params: {
